...
import com.pc.core.utils.AddressUtils;
...
public class TokenService {
    ...
    public String createToken(LoginUser loginUser) {
        ...
        claims.put(Constants.TOKEN_PREFIX, token);
    ...
    private String createToken(Map<String, Object> claims) {
        return Jwts.builder()
                .setClaims(claims)
                .signWith(SignatureAlgorithm.HS512, systemConfig.getSecret()).compact();
    }
    ...
    public Claims parseToken(String token) {
        return Jwts.parser()
                .setSigningKey(systemConfig.getSecret())
