...
import com.pc.service.mapper.DtsArticleMapper;
import com.pc.service.domain.DtsArticle;
import com.pc.service.domain.DtsArticle.Column;
import com.pc.service.domain.DtsArticleExample;
...
public class DtsArticleService {
    ...
    private DtsArticle.Column[] columns = new Column[]{Column.id, Column.title, Column.addTime, Column.type};
