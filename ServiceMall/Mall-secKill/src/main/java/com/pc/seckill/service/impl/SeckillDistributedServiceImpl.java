...
import com.pc.seckill.distributedlock.redis.RedissLockUtil;
import com.pc.seckill.distributedlock.zookeeper.ZkLockUtil;
        ...
        try {
            ...
            if (res) {
                ...
                if (number > 0) {
                    ...
                    secKillMapper.updateStockAndDed(seckillId);
                } else {
