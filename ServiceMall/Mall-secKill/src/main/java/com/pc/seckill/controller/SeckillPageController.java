...
import com.pc.seckill.common.utils.HttpClient;
import com.pc.seckill.common.utils.IPUtils;
...
public class SeckillPageController {
    ...
    public Result startSeckill(String ticket, String randstr, HttpServletRequest request) {
        ...
        if (!"1".equals(response)) {
            ...
            activeMQSender.sendChannelMess(destination, 1000 + ";" + new Random().nextInt(1000));
            return Result.ok();
        } else {
