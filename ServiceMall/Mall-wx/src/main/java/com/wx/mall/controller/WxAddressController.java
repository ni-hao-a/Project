...
import com.pc.service.domain.DtsAddress;
import com.pc.service.domain.DtsRegion;
import com.pc.service.service.DtsAddressService;
...
import com.wx.mall.service.GetRegionService;
...
public class WxAddressController extends GetRegionService {
	...
	public Object list(@LoginUser Integer userId) {
		...
		log.info("【请求结束】获取收货地址列表,响应结果:{}", JSONObject.toJSONString(addressVoList));
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		log.info("【请求开始】获取收货地址详情,请求参数,userId：{},id:{}", userId, id);
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		...
		log.info("【请求结束】获取收货地址详情,响应结果：{}", userId, id, JSONObject.toJSONString(data));
	...
	public Object save(@LoginUser Integer userId, @RequestBody DtsAddress address) {
		log.info("【请求开始】添加或更新收货地址,请求参数,userId：{},address:{}", userId, JSONObject.toJSONString(address));
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		...
		log.info("【请求结束】添加或更新收货地址,响应结果：{}", address.getId());
	...
	public Object delete(@LoginUser Integer userId, @RequestBody DtsAddress address) {
		log.info("【请求开始】删除收货地址,请求参数,userId：{},address:{}", userId, JSONObject.toJSONString(address));
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
