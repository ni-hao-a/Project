...
public class WxCartController {
    ...
    public Object add(@LoginUser Integer userId, @RequestBody DtsCart cart) {
        log.info("【请求开始】加入商品到购物车,请求参数,userId:{},cart:{}", userId, JSONObject.toJSONString(cart));
    ...
    public Object update(@LoginUser Integer userId, @RequestBody DtsCart cart) {
        log.info("【请求开始】修改购物车,请求参数,userId:{},cart:{}", userId, JSONObject.toJSONString(cart));
    ...
    public Object checked(@LoginUser Integer userId, @RequestBody String body) {
        log.info("【请求开始】勾选购物车商品,请求参数,userId:{},cart:{}", userId, JSONObject.toJSONString(body));
    ...
    public Object delete(@LoginUser Integer userId, @RequestBody String body) {
        log.info("【请求开始】购物车商品删除,请求参数,userId:{},cart:{}", userId, JSONObject.toJSONString(body));
    ...
    public Object checkout(@LoginUser Integer userId, Integer cartId, Integer addressId, Integer couponId,
        ...
        log.info("【请求开始】用户购物车下单,请求参数,userId:{}", userId);
        ...
        if (couponId == null || couponId.equals(-1)) { // 1. 用户不想使用优惠券，则不处理
            ...
            // 用户选择的优惠券有问题
            if (coupon == null) {
                log.error("用户购物车下单失败:{}", INVALID_COUPON.desc());
        ...
        log.info("【请求结束】用户购物车下单,响应结果：{}", JSONObject.toJSONString(data));
